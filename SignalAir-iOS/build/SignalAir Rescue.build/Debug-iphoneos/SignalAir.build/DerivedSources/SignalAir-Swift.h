...
#ifndef SIGNALAIR_SWIFT_H
#define SIGNALAIR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SignalAir",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC9SignalAir14NetworkService")
...
@class NSData;
@class MCSession;
@interface NetworkService (SWIFT_EXTENSION(SignalAir)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface NetworkService (SWIFT_EXTENSION(SignalAir)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface NetworkService (SWIFT_EXTENSION(SignalAir)) <MCSessionDelegate>
...
SWIFT_CLASS("_TtC9SignalAir15PurchaseService")
