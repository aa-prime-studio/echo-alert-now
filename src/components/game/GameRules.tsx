  ...
  return (
    <Card className="bg-white border-black shadow-sm">
      <CardContent className="p-6">
        <h4 className="font-semibold text-gray-900 mb-4 text-left" style={{ fontSize: '17px' }}>遊戲規則</h4>
        <div className="grid grid-cols-3 gap-4">
          <div className="text-left">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-1">號碼範圍</p>
          ...
          <div className="text-left">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-1">獲勝條件</p>
          ...
          <div className="text-left">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-1">每日排行</p>
